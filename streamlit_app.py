...
with st.expander("Display instructions"):
    st.write(\"\"\"
        ...
        Still, as with AI responses in general, the AI could be entirely wrong, just a bit wrong, or correct, but you should always check your answers for errors. 
        Use this entirely at your own risk, there is no warrany, implied or otherwise for the correctness of the answers, or that this is fit for 
        any use at all.

        There is a Vectara Corpus feeding an OpenAI chatbot behind this chat interface. The complete OMNEST/OMNeT++ documentation, the
        INET Framework documentation and showcases have been fed into and indexed in the Vectara Corpus. When you submit a querry, first
